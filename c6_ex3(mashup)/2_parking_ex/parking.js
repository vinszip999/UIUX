...
function handleRefresh() {
	for (var i = 1; i < 16000; i = i + 1000)//16번 호출 i=1 j=1000, i=1001 j=2000, i=2001 j=3000,..., i=15001 j=16000 까지
	{
		...
		var url = "http://openAPI.seoul.go.kr:8088/4a504a656d76696e3434684a626469/json/GetParkInfo/" + i + "/" + j;
...
function updatePark(parks) {//16번 호출
	...
	for (var i = 0; i < arr.length; i++) {
		var park = arr[i];
		var imageSrc = "img/marker1.png",
			imageSize = new daum.maps.Size(40, 40), //마커의 크기(daummap에서 size 검색, 크기정보를 가지고 있는 사이즈 객체 생성)
...
function addBound() { // 원 색깔임
	// 지도에 표시할 원을 생성합니다
	var bound = new daum.maps.Circle({
		center: map.getCenter(),  // 원의 중심좌표 입니다 
		radius: 1000, // 미터 단위의 원의 반지름입니다 
		strokeWeight: 5, // 선의 두께입니다 
		strokeColor: '#990099', // 선의 색깔입니다
		strokeOpacity: 0.7, // 선의 불투명도 입니다 1에서 0 사이의 값이며 0에 가까울수록 투명합니다
		strokeStyle: 'dashed', // 선의 스타일 입니다
		fillColor: '#e5ccff', // 채우기 색깔입니다 #99ccff #66b2ff
